...
void HardFault_Handler(void)
{
  ...
  // Decode CFSR
  if (cfsr & (1 << 7))  printf("  -> MMARVALID: MMFAR contains valid address\n");
  ...
  if (cfsr & (1 << 15)) printf("  -> BFARVALID: BFAR contains valid address\n");
  ...
  printf("System crashed during ITTIA DB initialization\n");
